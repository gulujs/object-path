...
const RE_CONTROL_CHAR_AND_SINGLE_QUOTE = /[\u0000-\u001F\u007F']/;
const RE_CONTROL_CHAR_AND_SINGLE_QUOTE_EXCLUDE_TAB_CHAR = /[\u0000\u0008\u000A-\u001F\u007F']/;
const RE_ENCODE_REPLACE_PATTERN = /[\u0000-\u001F\u007F"\\]/g;
...
export class QuoteStyleKeyPath extends BaseKeyPath {
  constructor(options = {}) {
    ...
    this.RE_CONTROL_CHAR_AND_SINGLE_QUOTE = RE_CONTROL_CHAR_AND_SINGLE_QUOTE;
    this.RE_ENCODE_REPLACE_PATTERN = RE_ENCODE_REPLACE_PATTERN;
    if (options.escapeTabChar !== true) {
      this.RE_CONTROL_CHAR_AND_SINGLE_QUOTE = RE_CONTROL_CHAR_AND_SINGLE_QUOTE_EXCLUDE_TAB_CHAR;
  ...
  encode(key) {
    ...
    if (this.preferQuote === CHAR_SINGLE_QUOTE && !this.RE_CONTROL_CHAR_AND_SINGLE_QUOTE.test(key)) {
      return `'${key}'`;
    }
